    ...
    <div id="app">
        ...
        <el-dialog title="添加/修改信息" :visible.sync="dialogFormVisible" width="430px">
            <el-form :model="manager" :rules="rules" ref="managerForm">
                <div style="margin:0 auto;text-align:center;margin-bottom: 7px">
                    <el-upload
                ...
                <el-form-item label="性别" :label-width="formLabelWidth"   prop="managerSex" >
                    <el-select v-model="manager.managerSex" placeholder="性别" style="width:315px">
                ...
                <el-col :span="3">
                    <div class="grid-content bg-purple">
                            <el-button type="primary"  >
                                <a  style="color:white;text-decoration:none;" href="<%=basePath%>static/template/manager.xlsx">模板下载</a>
                            </el-button>
                    </div>
                </el-col>
        ...
        <template>
            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="pwer_role(scope.row)" type="text" size="small">授权</el-button>
        ...
        new  Vue({
            ...
            methods:{
                ...
                handleCheckedRolesChange(){
                    ...
                    axios.post('<%=basePath%>admin/manager/saverpower',Qs.stringify(data))
                        .then(function(res){
